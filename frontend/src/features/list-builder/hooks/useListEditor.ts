...
export function useListEditor(id: string | undefined) {
  ...
  return {
    ...
    wargearSubOptions: store.wargearSubOptions,
    unitWargearSelections: store.unitWargearSelections,
    unitWargearRowIds: store.unitWargearRowIds,
    unitWargearSubSelections: store.unitWargearSubSelections,
    ...
    selectWargearSubOption: store.selectWargearSubOption,
